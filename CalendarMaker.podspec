#
#  Be sure to run `pod spec lint CalendarMaker.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "CalendarMaker"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of CalendarMaker."
  ...
  spec.homepage     = "http://EXAMPLE/CalendarMaker"
  ...
  spec.source       = { :git => "http://EXAMPLE/CalendarMaker.git", :tag => "#{spec.version}" }
